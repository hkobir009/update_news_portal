...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
      ...
      $categoryposts =category::with('posts')->where('id',18)->get();
      ...
      $categoryposts =category::with('posts')->where('id',12)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }   
      ...
      $categoryposts =category::with('posts')->where('id',14)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',13)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',11)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',31)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',15)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
...
// dd($category_wize_post);
      ...
      $categoryposts =category::with('posts')->where('id',22)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',17)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',16)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',10)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',2)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',5)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',4)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',3)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',6)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',1)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',37)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',32)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',33)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',34)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',35)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',7)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
      ...
      $categoryposts =category::with('posts')->where('id',8)->get();
      foreach($categoryposts as $categorypost){
            $category_wize_post =$categorypost->posts;  
        }
