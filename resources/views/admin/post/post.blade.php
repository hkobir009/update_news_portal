            ...
            <div class="row d-flex justify-content-center p-4">
               <div class="dashbard-content-header d-flex align-items-center justify-content-between">
                  <div class="title my-5">
                     <h1 class="text-capitalize p-0 fw-bold">post form</h1>
                  </div>
               ...
               <div class="forms mb-5 pb-5">
                  <form action="">
                   ...
                   <div class="select-any w-100 mt-5">
                     <label for="" class="text-capitalize mb-2">Select one</label>
                  ...
                  <div class="slag mt-5">
                     ...
                     <input class="form-control py-2" type="text" placeholder="slag">
                  </div>
