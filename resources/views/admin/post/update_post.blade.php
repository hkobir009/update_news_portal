               ...
               <div class="forms mb-5 pb-5">
                  <form action="" mathod="post">
                    ...
                    <div class="user-name">
                       ...
                       <input class="form-control py-2" type="text" name="title" value="{{$data->title}}" placeholder="post title">
                   </div>
                   ...
                   <div class="body mt-5">
                     ...
                     <textarea class="w-100" name="body" value="" placeholder="Post body">{{$data->body}}</textarea>
                  </div>
                  <div class="slag mt-5">
                     <label for="" class="text-capitalize mb-2">slag</label>
                     <input class="form-control py-2" name="slug" value="{{$data->slug}}" type="text">
                  </div>
                  <div class="image mt-5">
                     <label for="" class="text-capitalize mb-2">Image</label>
                     <input class="form-control py-2" type="file" value="{{$data->image}}" name="image" placeholder="image">
                  </div>
                      <input type="submit" value="Update Post" class="form-control mt-5 btn-outline-info">
                  </form>
              </div><!--forms-->
           </div><!--container-->
         </div>
