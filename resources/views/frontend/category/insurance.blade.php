      ...
      <div class="row">
        <div class="col-lg-9">
            <a href="#" class="py-1 pt-3 d-block">
              <h1 class="jatiyo-page-title border-bottom">বীমা</h1>
            </a>
          ...
          <div class="row border-bottom pb-md-4">
            <div class="col-lg-8 ">
              <div class="big-news-top">
                <div class="top-middle mb-3 mb-lg-0">
                  ...
                  @foreach ($insurance_sec_1_item as $item)
                  <div class="news-item">
            ...
            <div class="col-lg-4">
              <div class="jatiyo-page-two-little  d-flex flex-column justify-content-between">
                ...
                @foreach ($insurance_sec_2_item as $item)
          ...
          <div class="row mt-3">
            ...
            @foreach ($insurance_sec_3_item as $item)
